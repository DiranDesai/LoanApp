...
function LoanBanner() {
  return (
    <div className="p-5 mt-6 rounded-md bg-red-500 loan-banner">
        ...
        <Link to="/apply"><button type="button" className="flex rounded-full bg-white px-4 py-3 mt-5 font-bold"><PencilSquareIcon className="w-6 h-6"/> Apply Loan</button></Link>
    </div>
  )
}
